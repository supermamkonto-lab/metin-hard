...
class TestLoadConfigErrors:
    ...
    def test_nonexistent_output_dir_raises_config_error(self, tmp_path: Path) -> None:
        """Nieistniejący folder wyjściowy → ConfigError."""
        ...
        assert "nie istnieje" in str(exc_info.value).lower() or "folder" in str(exc_info.value).lower()
